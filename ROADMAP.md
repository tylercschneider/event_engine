...
- [ ] **Add ActiveSupport::Notifications instrumentation** — Instrument: `event_engine.event_emitted`, `event_engine.event_published`, `event_engine.event_dead_lettered`, `event_engine.publish_batch`. Include event_name, event_version, duration in payloads. Foundation for APM integration and the separate analytics project. ([#44](https://github.com/tylercschneider/event_engine/issues/44))
